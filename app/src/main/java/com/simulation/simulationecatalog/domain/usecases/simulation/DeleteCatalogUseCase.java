...
public class DeleteCatalogUseCase extends CoreUseCase<Integer, Integer> {

    private UseCaseResultEvent<Integer> useCaseResultEvent;

    public DeleteCatalogUseCase(UseCaseResultEvent<Integer> useCaseResultEvent) {
        this.useCaseResultEvent = useCaseResultEvent;
    }

    @Override
    public Observable<Integer> buildObservable(Integer delete) {
        return SimulationRoomDatabase.getInstance().deleteAllCatalog();
    }
    ...
    class DisposableObserver extends DisposableObservable<Integer> {
        ...
        public void onError(Throwable e) {
            super.onError(e);
            useCaseResultEvent.onError(e,"delete catalog fail");
        }
    }
}